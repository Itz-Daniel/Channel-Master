...
module.exports = (client, message, args, cmd, prefix) => {
    ...
    if (!args[0])
      return message.reply(new Discord.MessageEmbed()
        ...
        .setDescription(`PREFIX: \`${prefix}\` | [Click here - Support Server](https://dsc.gg/codingzone)\n\n*Enter the right Category, to see help for them* Example: \`${prefix}help voice\`\n[\`INVITE ME\`](https://discord.com/api/oauth2/authorize?client_id=761247967859965982&permissions=8&scope=bot) | Developer: \`</ Itz_Danny >#3514\``)
    ...
    switch (args[0].toLowerCase()) {
      case "general":
        return message.reply(new Discord.MessageEmbed()
          ...
          .addField(`\`${prefix}add\``, "> *[Invite](https://discord.com/api/oauth2/authorize?client_id=869337640477032499&permissions=8&scope=bot) the Bot!*", true)
          .addField(`\`${prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://dsc.gg/codingzone) of the Bot!*", true)
